...
export const buttonPrimaryPressed = styles(
    buttonPrimary(),
    "bg-(--color-primary-hover)"
);
export const buttonPrimarySmall = styles(
    button(),
    primary,
    "font-semibold px-2"
);
...
export const buttonSecondarySmall = styles(
    button(),
    secondary,
    "font-semibold px-2"
);
...
export const buttonTertiarySmall = styles(
    button(),
    tertiary,
    "font-semibold px-2"
);
