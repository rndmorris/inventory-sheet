                ...
                header: (
                    <>
                        ...
                        <button
                            ...
                            onClick={() =>
                                MUT_INV_ITEMS.delete(invItem.id, "update")
                            }
                        >
                            -
                        </button>
                ...
                body: (
                    <>
                        <header className="flex justify-start gap-2">
                            <span>
                                <b>Weight</b> {invItem?.weight?.toFixed(2)}
                            </span>
                            <span>
                                <b>Value</b> {invItem?.value?.toFixed(2)}
                            </span>
                        </header>
                        <main>{invItem.desc}</main>
                    </>
                ),
            }))}
        />
